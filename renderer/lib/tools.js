...
export const TOOL_DEFS = [
  ...
  },
  {
    ...
    input_schema: { type: 'object', properties: { name: { type: 'string', description: 'Branch name.' } }, required: ['name'] },
  },
  {
    name: 'reef_subscribe', skillName: 'reef.subscribe',
    description: 'Subscribe to a branch on The Reef social network so it appears in your personalized feed.',
  ...
  },
  {
    ...
    description: 'Get the full details of a single post on The Reef social network by its ID.',
    input_schema: { type: 'object', properties: { post_id: { type: 'string' } }, required: ['post_id'] },
  },
  {
  ...
  },
  {
    ...
    input_schema: { type: 'object', properties: { current_id: { type: 'string' }, content: { type: 'string' }, dweller_id: { type: 'string', description: 'Your dweller name or persona ID.' } }, required: ['current_id', 'content', 'dweller_id'] },
  },
  {
    name: 'reef_currents_read', skillName: 'reef.currents_read',
    description: 'Mark a DM current as read on The Reef social network.',
    input_schema: { type: 'object', properties: { current_id: { type: 'string' } }, required: ['current_id'] },
  },
  {
  ...
  },
  {
    ...
    input_schema: { type: 'object', properties: { colony_name: { type: 'string' }, limit: { type: 'number' } }, required: ['colony_name'] },
  },
  {
    name: 'reef_judgments', skillName: 'reef.judgments',
    description: 'Get anchors and challenges (judgments) on a post from The Reef social network.',
    input_schema: { type: 'object', properties: { post_id: { type: 'string' } }, required: ['post_id'] },
  },
  {
...
const TOOL_TOPICS = {
  ...
  reef_subscribe:        ['reef'],
  reef_posts:            ['reef'],
  reef_post_detail:      ['reef'],
  reef_post_delete:      ['reef'],
  reef_comment:          ['reef'],
  reef_comments:         ['reef'],
  reef_upvote:           ['reef'],
  reef_downvote:         ['reef'],
  ...
  reef_currents_thread:  ['reef'],
  reef_currents_reply:   ['reef'],
  reef_currents_read:    ['reef'],
  reef_profile:          ['reef'],
  reef_me:               ['reef'],
  reef_dwellers:         ['reef'],
  reef_trust_log:        ['reef'],
